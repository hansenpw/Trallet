...
public class RealmHelper {
    ...
    static void deleteBook(Realm realm, int bookId) {
    ...
    public static void deleteExpense(Realm realm, int expenseId) {
        realm.beginTransaction();
...
//        temp.setTotal(temp.getTotal() + value);
    ...
    public static void setBookDelete(Realm realm, int bookId, int expenseId) {
        realm.beginTransaction();
